...
enum cyberdeck_cmd_type_t {
    ...
    CYBERDECK_CMD_BATTERY_PROTECTION_ON,
    CYBERDECK_CMD_BATTERY_PROTECTION_OFF,
    CYBERDECK_CMD_BATTERY_PROTECTION_STATUS,
    CYBERDECK_CMD_SSH,
    CYBERDECK_CMD_BLUETOOTH_SEARCH,
    CYBERDECK_CMD_BLUETOOTH_PAIRED,
